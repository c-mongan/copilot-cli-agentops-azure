...
function alertTuningDashboard() {
  const panels = [
    ...
    tablePanel(30, 'Fired alert candidates', 0, 31, 24, 12, alertHistoryDashboardQuery(100), [
      byNameLink('Conversation', 'Open session detail', '/d/agentops-session-detail?var-conversation=${__data.fields.Conversation}'),
