...
The route-plan command turns that safe handoff context into preview-only GitHub Issue or Azure DevOps Work Item payloads. The tune-plan, policy, handoff, route-plan, and incident timeline commands keep remediation as review placeholders; they do not edit alert thresholds, enable rules, page anyone, post payloads, or create work items.
